...
public class WebServer {
  ...
  public static final String RESIGN_ROUTE = "/resignGame";
  ...
  public void initialize() {
    ...
    post(SIGNOUT_URL, new PostSignOutRoute(playerLobby,gameCenter,gson));
    post(HOME_URL, new PostSignInRoute(templateEngine));
    get(GAME_URL, new GetGameRoute(templateEngine, gameCenter, playerLobby,gson));
    post(VALIDATE_MOVE_URL, new PostValidateMoveRoute(gameCenter, gson, playerLobby));
    post(RESIGN_ROUTE, new PostResignRoute(playerLobby,gameCenter,gson));
