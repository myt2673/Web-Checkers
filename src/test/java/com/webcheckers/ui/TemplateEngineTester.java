...
public class TemplateEngineTester {
  ...
  /** Holds the View-com.webcheckers.Model map from the Spark ModelAndView object. */
  ...
  /**
   * Assert that the View-com.webcheckers.Model object exists.
   */
  public void assertViewModelExists() {
    assertNotNull(model, "the View-com.webcheckers.Model exists");
  }
  ...
  public void assertViewModelIsaMap() {
    assertTrue(model instanceof Map, "the View-com.webcheckers.Model is a Map");
  }

  /**
   * Assert that the View-com.webcheckers.Model attributes matches the expected value.
   */
  ...
  /**
   * Assert that the View-com.webcheckers.Model attribute is absent.
   */
